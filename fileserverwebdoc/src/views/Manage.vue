  ...
  <a-layout>
    <a-layout-header class="g-header">
      ...
      <a-row style="line-height:1.5">
        <a-col :xs="12">
          <a-button-group>
            ...
            >{{breakpoint?'':'New Folder'}}</a-button>
            <a-modal
              title="New Folder"
            ...
            >
              <a-input
                ...
                @blur="checkdirname"
              />
              <p v-if="mkdirtipsvisible" style="color:red">Please input correct folder name</p>
            </a-modal>
          </a-button-group>
        </a-col>
        <a-col :xs="12">
            ...
            <a-button-group>
              ...
              >
                <div>
                  ...
                  <span>{{uploadfile==null?'No File Selected':uploadfile.name}}</span>
                </div>

                <p>File will upload in current folder</p>
                <p>Upload only one file at a time</p>
              </a-modal>
              ...
              >
                <p>Be sure to delete the selected files and folders</p>
              </a-modal>
            </a-button-group>
          </div>
        </a-col>
      ...
      <a-row type="flex" justify="space-around" align="middle" class="filepanel">
        <a-col :xs="15" :sm="11">File Name</a-col>
        <a-col :xs="6">File Size</a-col>
        <a-col :xs="0" :sm="6">Last Modified</a-col>
        <a-col :xs="3" :sm="1" style="text-align: center">More</a-col>
      </a-row>
    </a-layout-header>
    <a-layout-content class="g-content">
      ...
      >
        ...
        <a-input
          ...
          @blur="checkfilename"
        />
        <p v-if="renametipsvisible">Please enter a valid file name</p>
      </a-modal>
    </a-layout-content>
  </a-layout>
</template>
